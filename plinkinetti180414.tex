...
%% Last-Updated: 2018-07-13T23:45:23+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
The Kantorovich distance is a distance in the strict sense of the term
\citep[\sect~I.C.11]{choquetbruhatetal1977_r1996}[\chap~2]{rudin1953_r1976}.
in the space of probability distributions. For two probability
distributions $\pf(\yO_{s} \|\yI')$, $\pf(\yO_{s} \|\yI'')$ it is defined
as the smallest expected value of the distance *** It is equivalent to the
\begin{multline}
