...
%% Last-Updated: 2018-04-17T15:44:37+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
and then assessed their answer, \enquote{a chef}, as bad because they
didn't guess that it was a carpenter\mynote{L: alright, I must find a
  better example}.
...
To avoid this paradox we can find other assessment measures. For example,
we can set up several inference robots, constructed according to different
