...
%% Last-Updated: 2018-07-01T01:48:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
The latter formula has an interesting interpretation: the distribution the
robot calculates for the $m$th observation is equal to a weighted sum of
the initial distribution~\eqref{eq:initial_predictive_JD} and the observed
relative frequencies $\yf$. The weights are the parameter $\yN$ and the
