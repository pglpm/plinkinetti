...
%% Last-Updated: 2018-04-14T17:50:44+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
proportional to $\yq^L$ for some value of $L>0$. This prior is determined
by the additional assumption -- call it $\yMJ$ -- that that the frequencies of
...
corresponding predictive distribution can be calculated analytically.
