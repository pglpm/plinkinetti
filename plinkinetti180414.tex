...
%% Last-Updated: 2018-05-29T01:29:51+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
shown in table~\ref{tab:adamsetal_algorithm}. For $m=0$ some preliminary
initialization steps are necessary.
\begin{table}[!b]
  \centering
  \begin{tabularx}{\textwidth}{X}\hline
        \begin{enumerate}[0.1.]
    \item Set $m=0$. Using the Johnson-Dirichlet model calculate
      \(\p(D^{1}_{d_{1}} \|  \yI) \)
    \item Save $B_1(r)\equiv 1$, $r=0$ into memory
...
\item Save $\set{B_{m+1}(r) \suchthat 0\le r \le m}$ into memory
\item Observe $d_{m+1}$, increase $m$ by $1$, go to step~\ref{item:first_step}
  \end{enumerate}
  \\\hline
\end{tabularx}
