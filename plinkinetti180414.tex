...
%% Last-Updated: 2018-07-01T02:24:49+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\enquote{state of belief} of this robot before the $(m+1)$th observation can be
represented by parameters $\bigl( \yNo{m+1}, \yno{m+1} \bigr)$ that are
updated recursively from those before the previous observation:
\begin{equation}
...
for \emph{all} other slots by the same proportion.
