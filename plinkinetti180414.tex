...
%% Last-Updated: 2018-04-15T12:18:06+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
What happens during the sequence of observations is this. Suppose that
after some observations the predictive distribution is $\yn$, and that the
next outcome is $k$. Then the probability for slot $k$ is updated to
$\frac{\yN\ynn_k+1}{\yN+1}$, and that for all other slots $j$ to
...
\item A participant who, after observing outcome $k$, raises the bar under that
