...
%% Last-Updated: 2018-04-18T10:18:50+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{figure}[t!]
\centering\includegraphics[width=\linewidth]{{comparisons1/avg_compare_robots_wide2narrow-stub_0.1}.pdf}
\includegraphics[width=\linewidth]{{comparisons1/avg_compare_robots_narrow2wide2-stub_0.1}.pdf}
\caption{Adaptation speed of the standard deviation for a robot after a
  change in the generation of the outcomes, compared with that of a robot
  that starts learning after the change, averaged over 100
  experiments}\label{fig:avg_comparison_robots_stds}
\end{figure}% done with exploration1.R
...
100 repetitions of such experiments, keeping the same means and standard
deviations of the generated normal.\mynote{L: so good?! must recheck the script.}
