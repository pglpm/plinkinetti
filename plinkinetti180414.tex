...
%% Last-Updated: 2018-07-02T15:38:15+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\end{multline}
There's a Bayesian robot that yields exactly the participant's
distributions: it's the robot $\yIp$ for which
\begin{subequations}
  ...
  \begin{equation}
    ...
    \text{participant's}
  \end{equation}
  which give a normalized joint distribution~\eqref{eq:distr_statmodel}:
  \begin{multline}
  ...
  \end{multline}
\end{subequations}
which completely defines the robot's inferences.

This robot assumes the probabilities for all observations to be independent
of one another, and they happen to be equal to the participant's. One may
argue that this is an \enquote{unreasonable} robot, and that the
participants do not assume independence of the probabilities. \emph{But
  there's no way to prove this}, given the verbal information given to the
participants and the set-up of the Plinko experiments
\citep{filipowiczetal2014,filipowiczetal2016}.

Since the initial information given to the participants place no
