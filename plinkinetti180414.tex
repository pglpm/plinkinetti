...
%% Last-Updated: 2018-07-11T16:09:26+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
possible outcomes. Consider \fig~\ref{fig:whykantorovich} for example: the
distribution in red with solid edges has equal Shannon-Jansen distance
$0.69$ from the other two distributions, but has Kantorovich distance $5$
from the blue, dashed-edged distribution and Kantorovich distance $37$ from
the yellow, dotted-edged distribution.
\begin{figure}[b!]
