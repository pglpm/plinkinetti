...
%% Last-Updated: 2018-04-17T21:07:27+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\caption{Adaptation speed of a robot after a change in the generation of
  ...
  the change}\label{fig:comparison_robots_stds}
\end{figure}% done with exploration1.R
The results of this comparison are shown in
\fig~\ref{fig:comparison_robots_stds}. Even though slightly, it seems that
a robot adapts more slowly in going from a wide to a narrow distribution
than vice versa.
