...
%% Last-Updated: 2018-07-05T10:44:16+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
$\varOmicron^i_s$, and logical conjunction (\enquote{$\land$}) by a comma.
...
five, or six laws of probability
\begin{subequations}
    \label{eq:laws_prob}
  \begin{gather}
\p(\neg A \| \yI) = 1-\p(A \| \yI)\\    
...
$A\lor B \defd \neg(\neg A, \neg B)$ and
$A \limplies B \defd \neg(A, \neg B)$) to make numeric probabilistic
