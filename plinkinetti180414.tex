...
%% Last-Updated: 2018-07-11T16:44:27+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
possible outcomes. Consider \fig~\ref{fig:whykantorovich} for example: in
the Shannon-Jansen metric, the blue, dashed-edged distribution in the
middle and the yellow, dotted-edged distribution on the right are equally
distant ($0.69$) from the red, solid-edged distribution on the left. In the
Kantorovich metric, instead, the middle distribution is closer (distance
$5$) to the left one than the right one (distance $37$). Suppose that the
left distribution belongs to a participant; intuitively we would say that
the middle distribution captures the participant's beliefs better than the
right one.
\begin{figure}[b!]
