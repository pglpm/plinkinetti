...
%% Last-Updated: 2018-05-29T10:34:02+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{table}[!b]
  ...
  \begin{tabularx}{\textwidth}{X}\hline
    ...
    \item Set $m=0$. Using the Johnson-Dirichlet model calculate
      \[\p(D^{1}_{d_{1}} \|  \yI) =1/N, \qquad d_1 \in \set{1,\dotsc,N} \]
...
A(r,d_{m+1}) \defd \p(D^{m+1}_{d_{m+1}} \| R^{m+1}_{r}, D^{m}_{d_{m}},
          \dotsc, D^{m+1-r}_{d_{m+1-r}}, \yI) ={}\\[\jot]
         \frac{\yN\ynn_{d_{m+1}}+r\yff_{d_{m+1}}}{\yN + r},
        \end{multlined} \]
where $\yff_{d_{m+1}}$ is the relative frequency of outcome $d_{m+1}$ in the past
$r$ observations
...
\item For $d_{m+1} \in \set{1,\dotsc,N}$, calculate
  \[ \p(D^{m+1}_{d_{m+1}} \| D^{m}_{d_{m}}, \dotsc, D^{1}_{d_{1}}, \yI) =
    \sum_{r=0}^{m} A(r,d_{m+1}) \times B_{m+1}(r)\]
