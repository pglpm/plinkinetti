...
%% Last-Updated: 2018-05-03T14:45:01+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\section{How hierarchic models get updated}
...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
Note that the denominator or the update
formula~\eqref{eq:update_h1} for $\yth$ is the updated
probability~\eqref{eq:update_h2} for $\ymu$. Note also that the space of
independent models $\set{\yth}$ can be different for different $\ymu$. 
...
which of such super-inferences is the most probable.
