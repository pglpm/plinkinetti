...
%% Last-Updated: 2018-07-05T08:40:50+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\begin{multline}
  ...
  \p( \varOmicron^M_{s_M}, \varOmicron^{M-1}_{s_{M-1}}, \dotsc,
  \varOmicron^2_{s_2}, \varOmicron^1_{s_1} \|  \yI)
  \quad\text{for all $s_1,\dotsc,s_M$}\\\text{(\ie, $N^M-1$ numbers)}
\end{multline}
...
\begin{subequations}
  \begin{align}
    &\p(\varOmicron^1_{s_1} \|\yI)
    \quad\text{all $s_1$} &&\text{($N-1$ values)},
\\\intertext{
the $N$ distributions for the second
  observation conditional on all possible first outcomes:}
    &\p(\varOmicron^2_{s_2} \|\varOmicron^1_{s_1}, \yI)
...
&\p(\varOmicron^M_{s_M} \|
\varOmicron^{M-1}_{s_{M-1}},\dotsc,\varOmicron^1_{s_1},\yI)
...
\emph{Bayesian robot} instead of a model. Such a robot uses the three or
four laws
of probability
\begin{subequations}
    \label{eq:laws_prob}
  \begin{gather}
\p(\neg A \| \yI) = 1-\p(A \| \yI)\\    
\p(A \lor B \| \yI) =\p(B \lor A \| \yI) = \p(A \| \yI)+\p(B \| \yI)-\p(A \| B,\yI)\;\p(B \| \yI)\\    
\p(A, B \| \yI) =\p(B, A \| \yI) = \p(A \| B,\yI)\;\p(B \| \yI)\\
\p(A\limplies B\|I) = \p(\neg A \| \yI) +\p(A \| B,\yI)\;\p(B \| \yI)
  \end{gather}
\end{subequations}
to make numeric probabilistic inferences and update them in
...
\item set its distribution for the $m$th observation conditional on the
  ...
  $\p(\varOmicron^m_{s_m} \|
  \varOmicron^{m-1}_{s_{m-1}},\dotsc,\varOmicron^1_{s_1},\yIp)$, equal to
...
\begin{multline}
  ...
  \p(\varOmicron^{m}_{s_{m}} \|
  R^{m}_{u},  \varOmicron^{m-1}_{s_{m-1}}, \dotsc, \varOmicron^{1}_{s_{1}}, \yMc)
  ={}\\
  \begin{cases}
  \p(\varOmicron^{m}_{s_{m}} \|
    R^{m}_{u},  \varOmicron^{m-1}_{s_{m-1}}, \dotsc, \varOmicron^{m-u}_{s_{m-u}}, \yMc)
...
\begin{equation}
  ...
  \p(R^{m}_{u_{m}} \| \varOmicron^{m-1}_{s_{m-1}},\dotsc, \varOmicron^{1}_{s_{1}}, \yMc),
\end{equation}
which in turn can be obtained by marginalization and condizionalization
from the probabilities
\begin{equation}
  \label{eq:prob_R_conditional_before}
  \p(R^{m}_{u_{m}} \| \varOmicron^{m-1}_{s_{m-1}}, R^{m-1}_{u_{m-1}},\dotsc,
  R^{2}_{u_{2}}, \varOmicron^{1}_{s_{1}}, \yMc)
\end{equation}
...
=  {}\\
  ...
  R^{m}_{u},  \varOmicron^{m-1}_{s_{m-1}}, \dotsc, \varOmicron^{m-u}_{s_{m-u}}, \yMc)
  \times
  \p(R^{m}_{u}, \varOmicron^{m-1}_{s_{m-1}} \| \varOmicron^{m-2}_{s_{m-2}} \dotsc, \varOmicron^{1}_{s_{1}}, \yMc)}{
\p(\varOmicron^{m-1}_{s_{m-1}} \| \varOmicron^{m-2}_{s_{m-2}} \dotsc, \varOmicron^{1}_{s_{1}}, \yMc)
}.
\end{multline}
...
and the joint probability for $(R^{m}_{u}, \varOmicron^{m-1}_{s_{m-1}})$ given the
...
\begin{multline}
 ...
 ={} \\
  \frac{\sum_{v=1}^{m-1}
    \p(R^{m}_{u}, \varOmicron^{m-1}_{s_{m-1}}, R^{m-1}_{v-1}, \varOmicron^{m-2}_{s_{m-2}}
...
\p(\varOmicron^{m-2}_{s_{m-2}} \| \varOmicron^{m-3}_{s_{m-3}}, \dotsc, \varOmicron^{1}_{s_{1}}, \yMc)}
  ...
  \p(\varOmicron^{m-1}_{s_{m-1}} \|
    R^{m-1}_{v-1}, \varOmicron^{m-2}_{s_{m-2}} \dotsc, \varOmicron^{m-v}_{s_{m-v}}, \yMc)
    \times{}\\
 \p(R^{m-1}_{v-1}, \varOmicron^{m-2}_{s_{m-2}} \|
  \varOmicron^{m-3}_{s_{m-3}},\dotsc, \varOmicron^{1}_{s_{1}}, \yMc).
\end{multline}
...
\item The last factor within the $v$ sum is analogous to the joint
  probability for $R^{m}_{u}, \varOmicron^{m-1}_{s_{m-1}}$, which we are now
...
\begin{subequations}\label{eq:definitions_ABC}
  \begin{align}
    ...
    \\
    B_{m}(u,s_{m})
                 &\defd \p(\varOmicron^{m}_{s_{m}} \| R^{m}_{u}, \varOmicron^{m-1}_{s_{m-1}},
                   \dotsc, \varOmicron^{m-u}_{s_{m-u}}, \yMc),
    \\
    C_{m}(u) &\defd
            \p(R^{m}_{u} , \varOmicron^{m-1}_{s_{m-1}} \| \varOmicron^{m-2}_{s_{m-2}}, \dotsc,
...
\begin{equation}
  \label{eq:initial_R2}
  \p(R^{2}_{u}, \varOmicron^{1}_{s_{1}} \|  \yMc)
  = \p(R^{2}_{u},R^{1}_{0}, \varOmicron^{1}_{s_{1}} \|  \yMc)
...
\begin{table}[!p]
  ...
  \begin{tabularx}{\textwidth}{X}\hline
   ...
   \item Calculate
      \[
        C_2(u) \defd \p(R^{2}_{u}, \varOmicron^{1}_{s_1} \| \yMc)
        =
A_1(s_1) \times \begin{cases}
      ...
      \item For $s_{2} \in \set{1,\dotsc,N}$, calculate
        \[ 
          B_{2}(u,s_{2}) \defd
          \p(\varOmicron^{2}_{s_{2}} \| R^{2}_{u}, \varOmicron^{1}_{s_{1}}, \yMc) =
...
\begin{table}[!p]
  ...
  \begin{tabularx}{\textwidth}{X}\hline
    \begin{enumerate}
      ...
      %   \[ B_m(v) \defd \p(R^{m}_{v} \| \varOmicron^{m-1}_{s_{m-1}} \dotsc,
      %     \varOmicron^{1}_{s_{1}}, \yMc),\qquad 0\le v \le m-1 \]
    \item\label{item:first_step}For $u \in \set{0,\dotsc, m}$:
      \begin{enumerate}[label*=\arabic*.]
      \item Calculate
        \[ \begin{multlined}[t][0.85\textwidth]
            C_{m+1}(u) \defd
            \p(R^{m+1}_{u} , \varOmicron^{m}_{s_{m}} \| \varOmicron^{m-1}_{s_{m-1}}, \dotsc,
...
B_{m+1}(u,s_{m+1}) \defd \p(\varOmicron^{m+1}_{s_{m+1}} \| R^{m+1}_{u}, \varOmicron^{m}_{s_{m}},
          \dotsc, \varOmicron^{m+1-u}_{s_{m+1-u}}, \yMc) ={}\\[\jot]
     ...
     where $\yff_{s_{m+1}}$ is the relative frequency of outcome $s_{m+1}$ in the previous $u$ observations
      ...
      %   \[ A_m(v) \defd \p(\varOmicron^{m}_{s_{m}} \| R^{m}_{v}, \varOmicron^{m-1}_{s_{m-1}}
      %     \dotsc, \varOmicron^{m-v}_{s_{m-v}}, \yMc)
      %   \]
  \end{enumerate}
\item For $s_{m+1} \in \set{1,\dotsc,N}$, calculate
  \[ \begin{multlined}[][0.85\textwidth]
...
%     \p(R^{m+1}_{u}\| \varOmicron^{m}_{s_{m}}, \dotsc, \varOmicron^{1}_{s_{1}}, \yI) 
%   % &=\sum_{v=0}^{m-1}
%   % \p(R^{m+1}_{u},R^{m}_{v},\|
%   % \varOmicron^{m}_{s_{m}}, \dotsc, \varOmicron^{1}_{s_{1}}, \yI)
%   % \\
% =\sum_{v=0}^{m-1}\p(R^{m+1}_{u} \| R^{m}_{v}, \yI)
%   \times
%   \p(R^{m}_{v} \|
%   \varOmicron^{m-1}_{s_{m-1}} \dotsc, \varOmicron^{1}_{s_{1}}, \yI).
% % &\!\begin{multlined}[b][0.7\textwidth]
% %   =\sum_{v=0}^{m-1}\p(R^{m+1}_{u} \| R^{m}_{v}, \yI)
% %   \times{}\\
% %   \p(\varOmicron^{m}_{s_{m}} \| R^{m}_{v},
% %   \varOmicron^{m-1}_{s_{m-1}} \dotsc, \varOmicron^{m-v}_{s_{m-v}}, \yI)
% %   \times{}\\
% %   \p(R^{m}_{v} \|
% %   \varOmicron^{m-1}_{s_{m-1}} \dotsc, \varOmicron^{1}_{s_{1}}, \yI).
% %           \end{multlined}
